package com.relative.chat.bot.ia.domain.messaging;
 ...
 import java.time.*;
 import java.util.*;
 public record ClientPhone(Id<ClientPhone> id, Id<Client> clientId, PhoneE164 phone, Channel channel, String provider, EntityStatus status, Instant verifiedAt){
public Optional<Instant> verifiedAtOpt(){return Optional.ofNullable(verifiedAt);
}
}